...
const getIcon = (type: TreatmentType) => {
  ...
  if (name.includes('muscular') || name.includes('muscle')) return <Bone className="w-full h-full text-white" />;
  if (name.includes('inmuno') || name.includes('immuno')) return <ShieldPlus className="w-full h-full text-white" />;
  if (name.includes('vitalidad') || name.includes('vitality')) return <Activity className="w-full h-full text-white" />;
  if (name.includes('vida c') || name.includes('life c') || name.includes('vitamina') || name.includes('vitamin')) return <Sun className="w-full h-full text-white" />;
