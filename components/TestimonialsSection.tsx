...
const VIDEOS: TestimonialVideo[] = [
  ...
  { id: 4, kind: 'video', name: 'Emmanuel Mendoza', condition: 'Acido hialurónico, PRP y bioregulador', rating: 5, src: '/assets/videos/testimonial_buffalo_5.mp4', poster: '/assets/images/testimonial_buffalo_1.jpg', language: 'es', typeLabel: 'Deportista de alto rendimiento', instagramUrl: 'https://www.instagram.com/p/DHW-2iDxzqD' }, // typeLabel: 'Dolor hombro - Deportista de alto rendimiento'
