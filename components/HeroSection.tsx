...
export default function HeroSection({ dictionary, locale }: HeroSectionProps) {
  return (
    <section className="relative pt-28 md:pt-32 lg:pt-36 pb-0 bg-gradient-to-br from-gray-50 via-white to-white overflow-hidden">
      {/* Decorative radial gradient */}
      <div className="absolute top-1/2 right-1/4 w-[600px] h-[600px] bg-gradient-radial from-accent-cool/10 via-accent-cool/5 to-transparent rounded-full pointer-events-none transform -translate-y-1/2 blur-3xl"></div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-end">
          ...
          <div className="flex flex-col justify-center pb-12 lg:pb-20 order-2 lg:order-1">
            ...
            <div className="badge badge-cool inline-flex items-center gap-3 px-5 py-3 rounded-full w-fit shadow-sm mb-8">
            ...
            <h1 className="text-[44px] sm:text-[52px] lg:text-[56px] xl:text-[64px] leading-[1.05] font-bold text-gray-900 tracking-tight mb-8">
              {locale === 'es' ? (
                <>
                  Recupera tu <span className="text-accent-cool">movilidad</span> y bienestar{' '}
                  <span className="text-accent-cool">sin cirugía</span>
                </>
              ) : (
                <>
                  Recover your <span className="text-accent-cool">mobility</span> and wellness{' '}
                  <span className="text-accent-cool">without surgery</span>
                </>
              )}
            </h1>

            {/* Subtitle con más margen inferior */}
            <h2 className="text-2xl sm:text-3xl lg:text-[34px] font-normal text-gray-900 leading-tight mb-8">
              {locale === 'es' 
            ...
            <div className="flex flex-col sm:flex-row gap-5 mb-12">
              <a
                ...
                className="btn btn-whatsapp inline-flex items-center justify-center gap-3 px-10 py-5 text-lg font-semibold rounded-full shadow-lg hover:shadow-xl"
              >
              ...
              <a
                ...
                className="btn btn-secondary inline-flex items-center justify-center gap-3 px-10 py-5 text-lg font-semibold rounded-full"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-10 border-t-2 border-gray-200">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-3xl font-light text-gray-900 mb-1">2000+</div>
          ...
          <div className="relative flex items-end justify-center lg:justify-end order-1 lg:order-2 h-full">
            <div className="relative w-full max-w-2xl">
              ...
              <div className="absolute bottom-0 right-0 lg:bottom-8 lg:right-8 bg-white rounded-2xl shadow-2xl p-6 border border-gray-200 hidden sm:block">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-accent-cool" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="text-base font-semibold text-gray-900 mb-1">Torre Medical</div>
                    <div className="text-sm text-gray-600">El Poblado, Medellín</div>
                  </div>
                </div>
              </div>
            </div>
