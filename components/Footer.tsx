...
export default function Footer({ dictionary, locale }: FooterProps) {
  ...
  const socialLinks = [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/deportologojames',
      icon: (
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/james.madrid.125?locale=es_LA',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-white no-print">
          ...
          <div>
            ...
            <ul className="space-y-4 !text-white">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span>consultoriomedicodrjamesmadrid@gmail.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 !text-white flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
