...
export default function FAQsSection({ dictionary, locale }: FAQsSectionProps) {
  ...
  return (
    <section id="preguntas" className="section-padding bg-gray-50">
      <div className="max-w-[1400px] mx-auto px-6 md:px-8 lg:px-12">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 group-hover:text-accent-cool transition-colors duration-300">
                      {faq.question}
                    </h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#contacto"
            className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-700 font-semibold px-6 py-3 rounded-full transition-all duration-300 shadow-md hover:shadow-lg border border-gray-200"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-whatsapp hover:bg-whatsapp-hover text-white font-semibold px-6 py-3 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
